/* Mobile Joomla! 2.0.4 | mobilejoomla.com/license.html */
jQuery(document).ready(function ($) {
    ...
    $('#mjmsgarea').load('http://ads.mobilejoomla.com/msg.html?v=2.0.4');

    $.ajax({
        url: 'http://www.mobilejoomla.com/getver.php?v=' + escape('2.0.4'),
