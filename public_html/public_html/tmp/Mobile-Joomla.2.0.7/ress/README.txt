...
- fileloader: way to load optimized js/css files ("file" for direct URLs or "php" for get.php loader)
- fileloaderphppath: path to directory with get.php file (./ - relative to ressio directory)
- filehashsize: length of filenames for generated files
- cachepath: path to cache directory (./ - relative to ressio directory)
...
- loadurl: allow to load and optimize external URLs
