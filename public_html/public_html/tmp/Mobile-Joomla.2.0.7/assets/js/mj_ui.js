/* Mobile Joomla! 2.0.7 | mobilejoomla.com/license.html */
jQuery(document).ready(function ($) {
    ...
    $('#mjmsgarea').load('http://ads.mobilejoomla.com/msg.html?v=2.0.7');

    $.ajax({
        url: 'http://www.mobilejoomla.com/getver.php?v=' + escape('2.0.7'),
