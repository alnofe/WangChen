...
window.addEvent('domready',function(){
	...
	function checkSubscription(){
		if(typeof Request == 'function'){
			new Request.HTML( {
				url: 'http://www.mobilejoomla.com/getsubs.php?app=$extid&domain=' + document.domain + '&v=' + escape('2.0.4'),
				method: 'get',
			...
			new Ajax( 'http://www.mobilejoomla.com/getsubs.php?app=$extid&domain=' + document.domain + '&v=' + escape('2.0.4'), {
				method: 'get',
