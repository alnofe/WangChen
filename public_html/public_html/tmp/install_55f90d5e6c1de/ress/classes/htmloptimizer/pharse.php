        ...
        switch ($node->tag) {
            ...
            case 'script':
                ...
                if (!isset($node->attributes['src'])) { // inline
                    ...
                    $isLocal = !$this->urlRewriter->isAbsoluteURL($srcFile);

                    // @todo break on *.php files

                    $merge = $merge && ($isLocal || $this->config->js->loadurl);
            ...
            case 'link':
                ...
                $hrefFile = $this->urlRewriter->urlToFilepath($href);
                // @todo: check type
                ...
                if (isset($node->attributes['ress-nomerge'])) {
                    ...
                    $merge = $this->config->css->loadurl || !$this->urlRewriter->isAbsoluteURL($hrefFile);
                }
