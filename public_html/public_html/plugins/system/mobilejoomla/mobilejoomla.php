...
//            $cookie_domain = $http_host;
    ...
    public function onAfterRender()
    {
        ...
        if ($this->mj->getParam('ress_optimize')) {
//        $text = $this->mj->generator->processPage($text);
            ...
            $options = array(
                ...
                'html' => array(
                    'mergespace' => (bool)$this->mj->getParam('html_mergespace'),
                    'removecomments' => (bool)$this->mj->getParam('html_removecomments'),
                    'urlminify' => (bool)$this->mj->getParam('html_minifyurl'),
                    'gzlevel' => 0
                ),
                'css' => array(
                    'merge' => (bool)$this->mj->getParam('css_merge'),
                    'loadurl' => (bool)$this->mj->getParam('css_loadurl'),
                    'inlinelimit' => (int)$this->mj->getParam('css_inlinelimit')
                ),
                'js' => array(
                    'merge' => (bool)$this->mj->getParam('js_merge'),
                    'loadurl' => (bool)$this->mj->getParam('js_loadurl'),
                    'autosync' => (bool)$this->mj->getParam('js_autosync'),
                    'wraptrycatch' => (bool)$this->mj->getParam('js_wraptrycatch'),
                    'inlinelimit' => (int)$this->mj->getParam('js_inlinelimit')
                ),
                'img' => array(
                    'jpegquality' => (int)$this->mj->getParam('jpegquality'),
                    'setdimension' => true,
                    'bufferwidth' => (int)$this->mj->getParam('buffer_width'),
