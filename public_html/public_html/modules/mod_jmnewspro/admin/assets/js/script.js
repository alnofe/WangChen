...
function jmnewspro_SourceChange(source){
    switch(source){
        case '1':
            ...
            jQuery('#jform_params_jmnewspro_orderby-lbl').parent().css({display:'block'});
            jQuery('#jform_params_jmnewspro_hikashop_orderby-lbl').parent().css({display:'none'});
            ...
            jQuery('#jform_params_jmnewspro_k2_image_size').parents('li').css({
                display:'none'
            });
           jQuery('#jform_params_jmnewspro_count').parent().css({
			...
			jQuery('#jform_params_jmnewspro_show_price').parents('li').css({
                display:'none'
            });
			jQuery('#jform_params_jmnewspro_file_image_url').parents('li').css({
                display:'none'
            });
			jQuery('#jform_params_jmnewspro_file_image_icon').parents('li').css({
                display:'none'
            });
			jQuery('#jform_params_jmnewspro_file_image_title').parents('li').css({
                display:'none'
            });
			jQuery('#jform_params_jmnewspro_file_image_title_link').parents('li').css({
                display:'none'
            });
			jQuery('#jform_params_jmnewspro_file_image_title_link_target').parents('li').css({
                display:'none'
            });
			jQuery('#jform_params_jmnewspro_file_image_desc').parents('li').css({
                display:'none'
            });
			jQuery('#jform_params_jmnewspro_file_image').parents('li').css({
                display:'none'
            });
			jQuery('#jform_params_jmnewspro_show_category').parents('li').css({
                display:'block'
            });
            jQuery('#jform_params_jmnewspro_display_menu_content').parents('li').css({
                display:'block'
            });
			jQuery('#jform_params_jmnewspro_display_menu_k2').parents('li').css({
                display:'none'
            });
            jQuery('#jform_params_jmnewspro_display_menu_product').parents('li').css({
                display:'none'
            });
            break;
        case '2':
        ...
        case '5':
            jQuery('#jform_params_jmnewspro_ordering').parents('li').css({display:'block'});
            jQuery('#jform_params_jmnewspro_orderby-lbl').parent().css({display:'none'});
            jQuery('#jform_params_jmnewspro_hikashop_orderby-lbl').parent().css({display:'block'});
            jQuery('#jform_params_jmnewspro_categories').parent().css({
                display:'none'
            });
            jQuery('#jform_params_jmnewspro_article_ids').parent().css({
		...
		case '8':
			...
			break;
		case '10':
            jQuery('#jform_params_jmnewspro_ordering').parents('li').css({display:'none'});
            jQuery('#jform_params_jmnewspro_orderby-lbl').parent().css({display:'none'});
            jQuery('#jform_params_jmnewspro_hikashop_orderby-lbl').parent().css({display:'none'});
            jQuery('#jform_params_jmnewspro_categories').parent().css({
                display:'none'
...
function jmnewspro_showPopupImage(option){
    if(option == 1){
        jQuery('#jform_params_jmnewspro_popup_text').parents('li').css('display','block');
        jQuery('#jform_params_jmnewspro_colorbox_transition').parents('li').css('display','block');
        jQuery('#jform_params_jmnewspro_colorbox_style').parents('li').css('display','block');
        jQuery('#jform_params_jmnewspro_colorbox_width').parents('li').css('display','block');
        jQuery('#jform_params_jmnewspro_colorbox_height').parents('li').css('display','block');
    }else{
        jQuery('#jform_params_jmnewspro_popup_text').parents('li').css('display','none');
        jQuery('#jform_params_jmnewspro_colorbox_transition').parents('li').css('display','none');
        jQuery('#jform_params_jmnewspro_colorbox_style').parents('li').css('display','none');
        jQuery('#jform_params_jmnewspro_colorbox_width').parents('li').css('display','none');
        jQuery('#jform_params_jmnewspro_colorbox_height').parents('li').css('display','none');
    }
}
