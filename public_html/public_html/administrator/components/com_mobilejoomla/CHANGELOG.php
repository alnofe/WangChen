...
2.0.9 Stable Release
- Fixed issue with optimization of *.min.css files

2.0.8 Stable Release
- Fixed compatibility issue with 3rdparty plugins in Mobile_Basic template
- Fixed html optimization settings

2.0.7 Stable Release
- Fixed issue with unoptimized content in System-Cache plugin
- Fixed issue with javascript optimization (failed on regexp in return statement)
- Optional server-side optimization
- New settings: Merge CSS, Merge JS, Load external, Catch errors, Non-blocking JS
...
- Added backward compatibility with legacy templates
- Fixed autoupdate
- Fixed unnecessary loading of DOMtastic script
- Added iPhone 6 Plus webapp icons and splash screen
- Updated jQuery
- Fixed issue with lazy loading script

2.0.2 Stable Release
- Fixed change of "Distribution method" parameter
- Fixed work in subdirectory
- Improved update from 1.2.x

2.0.1 Stable Release
- Fixed update from 2.0.alpha
- fixed popup module style
