...
extend($, type);
extend(api, attr, class_, data, event);
extend(apiNodeList);
$.version = '0.7.2';
$.extend = extend;
$.fn = api;
...
},{"./attr":2,"./class":3,"./data":4,"./event":5,"./selector":7,"./type":8,"./util":9}],2:[function(_dereq_,module,exports){
"use strict";
...
},{"./selector":7,"./util":9}],6:[function(_dereq_,module,exports){
"use strict";
